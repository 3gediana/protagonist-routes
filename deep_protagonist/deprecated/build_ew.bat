@echo off
REM D-122 early-warning dashboard build: both targets (train + viewer w/ --self-test).
...
echo === CONFIGURE ===
cmake -S . -B build_d122_v2 -G Ninja ^
...
echo === BUILD ===
cmake --build build_d122_v2 --target deep_protagonist_train deep_protagonist -j 6
